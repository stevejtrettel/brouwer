...
scene.torusView.core.visible = false; // the core isn't part of the Borsuk argument
...
presetGroup.add(
    // odd k winds the equator k times: a k-twisted Möbius band
    slider({ label: "twist k (odd)", min: 1, max: 5, step: 2, value: 1, onInput: (v) => { scene.source.params.k = v; scene.rebake(); } }),
